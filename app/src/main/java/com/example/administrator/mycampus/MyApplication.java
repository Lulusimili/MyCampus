package com.example.administrator.mycampus;
...
public class MyApplication extends Application {
    ...
    private SDKOptions options() {
        ...
        config.notificationSmallIconId = R.drawable.avatar_def;
        // 呼吸灯配置
    ...
    private LoginInfo loginInfo() {
        SharedPreferences preferences=getSharedPreferences("uData",MODE_PRIVATE);
